...
class MediaPlayerProxy:
    ...
    def get_instance(cls) -> MediaPlayer:
        if cls.INSTANCE is None:
            ...
            #
            # force_mpv overrides get_device_type() with the
            # authoritative baked DEVICE_TYPE whenever the model string
            # alone would route a Qt6 image to the Qt5 Gst player:
            ...
            #     stack, so the env override is what keeps it on mpv.
