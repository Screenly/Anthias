...
from anthias_server.api.urls.v1_1 import (
    get_url_patterns as get_url_patterns_v1_1,
)
from anthias_server.api.urls.v1_2 import (
    get_url_patterns as get_url_patterns_v1_2,
)
