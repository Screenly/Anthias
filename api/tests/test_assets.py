...
class V2ScheduleFieldValidationTest(TestCase):
    ...
    def test_update_with_empty_play_days_rejected(self) -> None:
    ...
    def test_update_with_partial_time_window_rejected(self) -> None:
        response = self.client.put(
            self.detail_url,
            data={
                **ASSET_UPDATE_DATA_V2,
    ...
    def test_update_with_full_time_window_accepted(self) -> None:
        response = self.client.put(
            self.detail_url,
            data={
                **ASSET_UPDATE_DATA_V2,
