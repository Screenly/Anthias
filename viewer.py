...
from lib.media_player import FFMPEGMediaPlayer
...
def sigusr1(signum, frame):
    ...
    # TODO: Use a general class for media player.
    # Pi devices currently use VLC, while x86 devices use FFmpeg.
    FFMPEGMediaPlayer.get_instance().stop()
...
def view_video(uri, duration):
    ...
    media_player = FFMPEGMediaPlayer.get_instance()
