...
if [ "$WEB_UPGRADE" = false ]; then
  ...
  # Set color and bold font of logo
  tput setaf 6
  tput bold
  cat << EOF
...
sudo apt-get install -y python-dev git-core libffi-dev libssl-dev openssl ssl-cert ca-certificates
