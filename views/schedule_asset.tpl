	...
	<div class="main">
		...
		<fieldset class="main">
			<form action="/process_schedule" name="asset" method="post">
				...
				<p>
					<strong><label for="asset">Asset: </label></strong>
				...
				<p>
					...
					<input id="start" type="textbox" name="start" value="{{datetime.now().strftime('%Y-%m-%d @ %H:%M')}}" />
				</p>
				<p>
					<strong><label for="end">End:</label></strong>
					<input id="end" type="textbox" name="end" value="{{(datetime.now() + timedelta(days=7)).strftime('%Y-%m-%d') + " @ 23:59"}}" />
				</p>
				<p>
					<strong><label for="duration">Duration:</label></strong>
					<input id="duration" type="textbox" name="duration" value="5" />
					<br />
					In seconds. Only for images and web-pages.
				</p>
				<p>
