...
(function() {
  var API, AddAssetView, App, Asset, AssetRowView, Assets, AssetsView, EditAssetView, date_settings, date_settings_uk, date_settings_us, date_to, delay, domains, get_filename, get_mimetype, get_template, insertWbr, mimetypes, now, time_settings, time_settings_12hour, time_settings_24hour, url_test, viduris,
    _this = this,
  ...
  time_settings = use_24_hour_clock ? time_settings_24hour : time_settings_12hour;

  date_settings = use_us_date ? date_settings_us : date_settings_uk;
  ...
  API.date_to = date_to = function(d) {
    ...
    return {
      ...
      time: function() {
        return dd.format(time_settings.time);
      }
    };
  };
  ...
  API.View.EditAssetView = EditAssetView = (function(_super) {
    ...
    EditAssetView.prototype.initialize = function(options) {
      ...
      (this.$('input.time')).timepicker({
        ...
        showInputs: true,
        disableFocus: true,
        showMeridian: time_settings.show_meridian
      });
